      ...
      <section className="bg-gray-100 min-h-screen flex items-center justify-center">
        ...
        <div className="bg-white flex rounded-2xl shadow-2xl p-5">
          ...
          <div className="md:w-1/2 px-16">
            <h2 className="font-bold text-2xl text-violet-500">SignUp Here</h2>
          ...
          <div className="md:block hidden w-1/2 bg-violet-500 text-white rounded-2xl py-4 px-4 shadow-gray-600 shadow-lg ">
            <div className="text-center font-bold mb-24">
            ...
            <div className="flex flex-col items-center justify-center">
              ...
              <p className="text-sm font-bold">"Join our vibrant community,</p>
            ...
            <div className="flex flex-col items-center justify-center">
              <button
                onClick={goToLogin}
                className="border-2 border-white rounded-xl px-8 py-2 inline-block font-semibold hover:bg-white hover:text-violet-500 mt-5 "
              >
                Login
              </button>
            </div>
